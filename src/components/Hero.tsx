  ...
  return (
    <section className="relative w-full h-screen flex items-center overflow-hidden">
      ...
      <div className="relative z-10 w-full px-6 sm:px-12 lg:px-16">
        {/* Staircase — centered on mobile, left on sm+ */}
        <div className="text-center sm:text-left">
          <p className="font-lufga text-[4rem] sm:text-[6rem] lg:text-[8rem] text-gray-900 leading-none">
            Sandra
          </p>
          <p className="font-lufga-100 text-kalam-black font-light text-[3rem] sm:text-[4.5rem] lg:text-[6rem] leading-none mt-[-0.5rem] pl-0 sm:pl-14 lg:pl-20">
            Braz Lemos
          </p>
          <p className="font-lufga text-xl sm:text-2xl lg:text-3xl text-kalam-black mt-2 pl-0 sm:pl-28 lg:pl-40">
